...
// Merdeka
let hariMerd = new Date('Agustus 18, 2024 23:59:59')
let sekarangg = new Date().getTime()
let lebih = hariMerd - sekarangg
...
let merdeka = `${harii} Hari ${jamm} Jam ${menitt} Menit ${detikk} Detik`


// Tahun Baru
let hariThunbru = new Date('April 21, 2023 23:59:59')
let sekarangg = new Date().getTime()
let lebih = hariThunbru - sekarangg
let harii = Math.floor( lebih / (1000 * 60 * 60 * 24));
let jamm = Math.floor( lebih % (1000 * 60 * 60 * 24) / (1000 * 60 * 60))
let menitt = Math.floor( lebih % (1000 * 60 * 60) / (1000 * 60))
let detikk = Math.floor( lebih % (1000 * 60) / 1000)
let thunbaru = `${harii} Hari ${jamm} Jam ${menitt} Menit ${detikk} Detik`
